...
<table id="total-tab" width="100%">
	...
	<tr>
		<td class="grey" width="50%">
			{l s='Total Products' mod='ts_orderconfirmation'}
		</td>
	...
	{if $footer.product_discounts_tax_excl > 0}
		...
		<tr>
			<td class="grey" width="50%">
				{l s='Total Discounts' mod='ts_orderconfirmation'}
			</td>
			<td class="white" width="50%">
	...
	{if $footer.wrapping_tax_excl > 0}
		<tr>
			<td class="grey">
				{l s='Wrapping Costs' mod='ts_orderconfirmation'}
			</td>
	...
	<tr class="bold">
		<td class="grey">
			{l s='Total (Tax excl.)' mod='ts_orderconfirmation'}
		</td>
		<td class="white">
	...
	<tr class="bold">
		<td class="grey">
			{l s='Total Tax' mod='ts_orderconfirmation'}
		</td>
		<td class="white">
	...
	<tr class="bold big">
		<td class="grey">
			{l s='Total' mod='ts_orderconfirmation'}
		</td>
		<td class="white">
